...
class GateSet(object):
    ...
    def bulk_product(self, evalTree, bScale=False):
        ...
        """
        return self._calc().bulk_product(evalTree, bScale)


    def bulk_dproduct(self, evalTree, flat=False, bReturnProds=False,
                      bScale=False, memLimit=None):
        """
    ...
    def bulk_hproduct(self, evalTree, flat=False, bReturnDProdsAndProds=False,
        ...
        """
        return self._calc().bulk_hproduct(evalTree, flat,
                                          bReturnDProdsAndProds, bScale)
    ...
    def bulk_pr(self, spamLabel, evalTree, clipTo=None, check=False):
        ...
        """
        return self._calc().bulk_pr(spamLabel, evalTree, clipTo, check)
    ...
    def bulk_probs(self, evalTree, clipTo=None, check=False):
        ...
        probs : dictionary
            ...
            for each spam label (string) SL.
        """
        return self._calc().bulk_probs(evalTree, clipTo, check)
