...
class GateSet(_collections.OrderedDict):
    ...
    def __init__(self):
        ...
        self.parameterization = StandardParameterizer()
    ...
    def get_dimension(self):
        ...
        int
            gateset dimension
        """
        return self.parameterizaton.get_dimension()
    ...
    def _rawupdate(self):
        for gateLabel, gateMatrix in self.parameterization.iter_gates():
            super(GateSet, self).__setitem__(gateLabel, gateMatrix)

        for index,rhoVec in self.parameterization.iter_rhovecs():
            if index < len(self.rhoVecs):
                self.rhoVecs[index] = rhoVec
            else:
                self.rhoVecs.append(rhoVec)

        for index,EVec in self.parameterization.iter_evecs():
            if index < len(self.EVecs):
                self.EVecs[index] = EVec
            else:
                self.EVecs.append(EVec)

        self.identityVec = self.parameterization.compute_identityvec()
        self.make_spams()

    def set_parameterization(self, parameterization_type, **parameterization_params):
        #TODO - ability to convert from one parameterization to another?
        pass
    ...
    def num_params(self):
        ...
        """
        return self.parameterizaton.num_params()
    ...
    def num_nongauge_params(self):
        ...
        """
        return self.parameterizaton.num_nongauge_params()
    ...
    def num_gauge_params(self):
        ...
        """
        return self.parameterizaton.num_gauge_params()
    ...
    def to_vector(self):
        ...
        """
        return self.parameterizaton.to_vector()
    ...
    def from_vector(self, v):
        ...
        """
        self.parameterizaton.from_vector()
        self._rawupdate()
    ...
    def get_vector_offsets(self):
        ...
        """
        return self.parameterizaton.get_vector_offsets()
    ...
    def deriv_wrt_params(self):
        ...
        numpy array
        """
        return self.parameterizaton.deriv_wrt_params()
    ...
    def transform(self, S, Si=None):
        ...
        Si : numpy array, optional
            ...
            Should be shape (gate_dim, gate_dim).
        """
        self.paramterization.transform(S,Si)
        self._rawupdate()
        self.make_spams()
...
#                scaleCache[i] = scaleCache[iLeft] + scaleCache[iRight] + log(nG)
    ...
    def copy(self):
        ...
        #TODO: update this to set gates using parameterization
    ...
    #Needed??
    def get_nongauge_projector(self):
        return self.parameterization.get_nongauge_projector()

    #Needed??
    def get_nongauge_projector_ex(self, nonGaugeMixMx):
        return self.parameterization.get_nongauge_projector_ex(nonGaugeMixMx)
...
#TODO: increase and decrease dimension through *parameterization*
