...
import gsparameterizer as _gsp
...
class GateSet(_collections.OrderedDict):
    ...
    def __init__(self):
        ...
        self.parameterization = _gsp.StandardParameterizer()
    ...
    def transform(self, S, Si=None):
        ...
        Si : numpy array, optional
            ...
            Should be shape (gate_dim, gate_dim).
        """
        self.parameterizaton.transform(S,Si,
                                       self.rhoVecs, self.EVecs,
                                       self.identityVec, self)
        self._rawupdate()
