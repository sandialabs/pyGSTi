...
def do_broad_seed_selection_iterative_mlgst(dataset, startGateset, gateStringSetsToUseInEstimation,
                       ...
                       alwaysPerformMLE=False, evaltree_cache=None, nSeeds=100, seeds=None,
                       earlyIteration=2):
    """
