...
\caption{\putfield{tt_hamiltonianProjectorTable}{}\textbf{Hamiltonian Error Generators}.  These error generators are used to project the error generator of the GST estimate. \label{hamiltonianProjectorTable}}
\end{center}
\end{table}
...
\caption{\putfield{tt_stochasticProjectorTable}{}\textbf{Stochastic Error Generators}.  These error generators are used to project the error generator of the GST estimate. \label{stochasitcProjectorTable}}
\end{center}
\end{table}
...
\caption{\putfield{tt_gaugeOptGatesetsVsTargetTable}{}\textbf{Per gate gauge optimized comparison with target}. \label{gaugeOptGatesetsVsTargetTable}}
\end{center}
\end{table}
...
\caption{\putfield{tt_gaugeOptCPTPGatesetChoiTable}{}\textbf{CPTP-gauge optimized Choi matrix table}. \label{gaugeOptCPTPGatesetChoiTable}}
\end{center}
\end{table}
