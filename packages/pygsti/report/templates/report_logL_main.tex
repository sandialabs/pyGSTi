...
If the ``generate appendices'' option was selected for this report, similar pixel plots for the intermediate estimates whose total $2\Delta\log(\mathcal{L})$ is listed in Table \ref{progressTable} can be found in Appendix \ref{appendix_logL_pixelplots}.
