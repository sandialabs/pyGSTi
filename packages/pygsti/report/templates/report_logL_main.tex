...
\begin{figure}
\begin{center}
\putfield{bestEstimateColorBoxPlot}{Box plot of best gateset logL}
...
\begin{figure}
\begin{center}
\putfield{invertedBestEstimateColorBoxPlot}{Box plot of best gateset logL with inverted box order}
