...
class BlankTable(WorkspaceTable):
    ...
    def _create(self, gateset, targetGateset, confidenceRegion, includeHSVec):
...
class SpamTable(WorkspaceTable):
    def __init__(self, ws, gateset, targetGateset=None, confidenceRegionInfo=None,
                 includeHSVec=True):
        """
        ...
        """
        super(SpamTable,self).__init__(ws, self._create, gateset,
                                       targetGateset, confidenceRegionInfo,
                                       includeHSVec)

    def _create(self, gateset, targetGateset, confidenceRegionInfo, includeHSVec):
...
class GatesTable(WorkspaceTable):
    def __init__(self, ws, gateset, confidenceRegionInfo=None):
        ...
        ReportTable
        """
        super(GatesTable,self).__init__(ws, self._create, gateset, confidenceRegionInfo)
...
class UnitaryGatesTable(WorkspaceTable):
    def __init__(self, ws, gateset, confidenceRegionInfo=None):
        """
        ...
        ReportTable
        """
        super(UnitaryGatesTable,self).__init__(ws, self._create, gateset, confidenceRegionInfo)
...
class ChoiTable(WorkspaceTable):
    def __init__(self, ws, gateset, confidenceRegionInfo=None):
        ...
        ReportTable
        """
        super(ChoiTable,self).__init__(ws, self._create, gateset, confidenceRegionInfo)

        
    def _create(self, gateset, confidenceRegionInfo=None):
...
#    def get_selected_gates_vs_target_table(gatesets, targetGateset, confidenceRegionInfo=None):
class CherryPickedGatesVsTargetTable(WorkspaceTable):
    def __init__(self, ws, gateset, targetGateset, confidenceRegionInfo=None):
        """
        ...
        ReportTable
        """
        super(CherryPickedGatesVsTargetTable,self).__init__(
            ws, self._create, gatesets,
            targetGateset, confidenceRegionInfo)
    
    def _create(self, gatesets, targetGateset, confidenceRegionInfo):
...
class ErrgenTable(WorkspaceTable):
    def __init__(self, ws, gateset, targetGateset, confidenceRegionInfo=None, genType="logG-logT"):
        ...
        super(ErrgenTable,self).__init__(ws, self._create, gateset,
                                         targetGateset, confidenceRegionInfo, genType)
...
class GateAnglesTable(WorkspaceTable):
    def __init__(self, ws, gateset, targetGateset, confidenceRegionInfo=None):
        """
        ...
        ReportTable
        """
        super(GateAnglesTable,self).__init__(ws, self._create, gateset, targetGateset, confidenceRegionInfo)
...
class ClosestUnitaryTable(WorkspaceTable):
    def __init__(self, ws, gateset, confidenceRegionInfo=None):
        """
        ...
        ReportTable
        """
        super(ClosestUnitaryTable,self).__init__(ws, self._create, gateset, confidenceRegionInfo)
...
class Chi2ProgressTable(WorkspaceTable):
    def __init__(self, ws, Ls, gatesetsByL, gateStringsByL, dataset,
                 gateLabelAliases=None):
        """
        ...
        ReportTable
        """
        super(Chi2ProgressTable,self).__init__(ws, self._create, Ls, gatesetsByL,
                                       gateStringsByL, dataset, gateLabelAliases)
    
    def _create(self, Ls, gatesetsByL, gateStringsByL,
                dataset, gateLabelAliases):
...
#                                gateLabelAliases=None):
class LogLProgressTable(WorkspaceTable):
    def __init__(self, ws, Ls, gatesetsByL, gateStringsByL, dataset,
                 gateLabelAliases=None):
        """
        ...
        ReportTable
        """
        super(LogLProgressTable,self).__init__(ws, self._create, Ls, gatesetsByL,
                                               gateStringsByL, dataset, gateLabelAliases)
    
    def _create(self, Ls, gatesetsByL, gateStringsByL, dataset,
                gateLabelAliases):
...
#                              gateLabelAliases=None):
class LogLByGermTable(WorkspaceTable):
    def __init__(self, ws, gateset, dataset, germs, strs, max_lengths,
                 baseStr_dict, fidpair_filters=None,
                 gatestring_filters=None,
                 gateLabelAliases=None):
        """
        ...
        ReportTable
        """
        super(LogLByGermTable,self).__init__(ws, self._create, gateset, dataset, germs, strs, max_lengths,
                                             baseStr_dict, fidpair_filters, gatestring_filters, gateLabelAliases)
    
    def _create(self, gateset, dataset, germs, strs, max_lengths,
                baseStr_dict, fidpair_filters, gatestring_filters, gateLabelAliases):
...
#                                         gateLabelAliases=None):
class LogLProjectedErrGenTable(WorkspaceTable):
    def __init__(self, ws, gateset, targetGateset,
                 gatestrings, dataset, 
                 cptpGateset=None, genType="logG-logT",
                 gateLabelAliases=None):
        ...
        ReportTable
        """
        super(LogLProjectedErrGenTable,self).__init__(ws, self._create, gateset, targetGateset,
                                                      gatestrings, dataset, cptpGateset, genType,
                                                      gateLabelAliases)
...
class GatestringTable(WorkspaceTable):
    def __init__(self, ws, gsList, title, nCols=1):
        """
        ...
        ReportTable
        """
        super(GatestringTable,self).__init__(ws, self._create, gsList, title, nCols)
    
    def _create(self, gsList, title, nCols):
...
class GatestringMultiTable(WorkspaceTable):
    def __init__(self, ws, gsLists, titles, commonTitle=None):
        """
        ...
        ReportTable
        """
        super(GatestringMultiTable,self).__init__(ws, self._create, gsLists, titles, commonTitle)

        
    def _create(self, gsLists, titles, commonTitle):
...
#                                               compare_with="target",
#                                               genType="logG-logT"):
class ErrGenComparisonTable(WorkspaceTable):
    def __init__(self, ws, gateset, targetGateset,
                 compare_with="target",
                 genType="logG-logT"):
        """
        ...
        ReportTable
        """
        super(ErrGenComparisonTable,self).__init__(ws, self._create, gateset, targetGateset,
                                                   compare_with, genType)
