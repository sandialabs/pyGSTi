...
##Unused, and really only applies to 1Q gates, so remove
...
#Unneeded: just create a gateset with this conglomeration of gates ahead of time and create a table with it.
...
##Unneeded: use ChoiTable now instead    
...
##Unneeded: currently unused, and if it is desired, can use 'X' of Progress table
##  to be 'Germ' and simply reduce the .yvals (germs) of a gss to specify only
##  the strings corresponding to a certain germ.
##    def get_logl_bygerm_table(gateset, dataset, germs, strs, max_lengths,
##                              baseStr_dict, fidpair_filters=None,
##                              gatestring_filters=None,
##                              gateLabelAliases=None):
#class ByGermTable(WorkspaceTable):
#    def __init__(self, ws, gatesets, dataset, germs, strs, max_lengths,
#                 baseStr_dict, fidpair_filters=None,
#                 gatestring_filters=None,
#                 gateLabelAliases=None):
#        """
...
##Use project_gateset(...) and FitComparisonTable
##    def get_logl_projected_err_gen_table(gateset, targetGateset,
##                                         gatestrings, dataset, 
##                                         cptpGateset=None, genType="logG-logT",
##                                         gateLabelAliases=None):
#class ProjectionFitsTable(FitComparisonTable):
#    def __init__(self, ws, gateset, targetGateset,
#                 gss, dataset, genType="logG-logT",
#                 display = (
#                 additionalGatesets=None, additionalLabels=None):
#        """
...
##Unneeded: merged to create new GatestringTable class
