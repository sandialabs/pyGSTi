...
def gate_matrix_boxplot(gateMatrix, size=None, m=-1.0, M=1.0, title=None,
                        save_to=None, fontSize=20):
    """
    ...
    cax = axes.imshow(gateMatrix,interpolation='nearest',cmap='bwr',vmin=m,vmax=M)
    axes.set_xticklabels([])
    axes.set_yticklabels([])
    axes.set_xticks(_np.arange(gateMatrix.shape[1]+1)-.5)
    axes.set_yticks(_np.arange(gateMatrix.shape[0]+1)-.5)
    axes.yaxis.grid(True,linestyle='-',linewidth=1.5)
    axes.xaxis.grid(True,linestyle='-',linewidth=1.5)
    tickVals = [one_sigfig(m), one_sigfig((m+M)/2), one_sigfig(M)]
    cbar = _plt.colorbar(cax,shrink=.75, pad=.1, aspect=18, ticks=tickVals)
    #cbar.ax.set_yticklabels(['a', '0', 'b'])
...
def gate_matrix_errgen_boxplot(gateMatrix, targetMatrix, size=None, title=None,
                               save_to=None, fontSize=20):
    """
    ...
    m,M = -absMax, absMax
    return gate_matrix_boxplot(errgen, size, m,M, title, save_to, fontSize)
...
def polar_eigenval_plot(gate, targetGate, size=(4,4), title=None,
    ...
    axes.plot(theta, r, linestyle='None', marker='o', color='b', markersize=8)
...
def pauliprod_hamiltonian_boxplot(gate, targetGate, size=None, title=None,
                                  save_to=None, fontSize=20, mxBasis="gm"):
    """
    ...
    return gate_matrix_boxplot(hamProjections, size, m,M, title, save_to, fontSize)
