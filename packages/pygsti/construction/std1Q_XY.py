...
gates = ['Gx','Gy']
fiducials = _GST.gatestring_list( [ (), ('Gx',), ('Gy',), ('Gx','Gx'),
                                       ('Gx','Gx','Gx'), ('Gy','Gy','Gy') ] ) # for 1Q MUB
#germs = _GST.gatestring_list( [('Gx',), ('Gy',), ('Gx', 'Gy'),
#                              ('Gx', 'Gx', 'Gy', 'Gx', 'Gy', 'Gy')] )
#These germs are not correct

germs = _GST.gatestring_list([('Gx',), ('Gy',), ('Gy','Gx','Gx'), ('Gy','Gy','Gx')])

#Construct a target gateset:  X(pi/2), Y(pi/2)
gs_target = _GST.build_gateset([2],[('Q0',)], ['Gx','Gy'],
                              [ "X(pi/2,Q0)", "Y(pi/2,Q0)"],
