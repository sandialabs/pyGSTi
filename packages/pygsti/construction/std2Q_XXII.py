...
germs = _strc.gatestring_list( [
        ...
        ('Giy', 'Gxx', 'Gxi', 'Gxx', 'Gix', 'Gxi', 'Gxi', 'Gyi'),
        ('Gxx', 'Gix', 'Gix', 'Gxx', 'Gxx', 'Gyi', 'Giy', 'Giy'),
        ('Gii', 'Giy', 'Gix', 'Gxx', 'Gxx', 'Gii', 'Gyi', 'Gxi'),
        ('Gxi', 'Giy', 'Giy', 'Giy', 'Gxx', 'Gix', 'Gyi', 'Gyi')
        ] )

#Construct the target gateset
gs_target = _setc.build_gateset(
    [4], [('Q0','Q1')],['Gii','Gix','Giy','Gxi','Gyi','Gxx'],
