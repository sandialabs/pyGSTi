...
def randomRot(scale,arrType = _np.array, seed=None):
    if seed is not None:
...
def makeQutritGS(errorScale,Xangle = _np.pi/2, Yangle = _np.pi/2, MSglobal = _np.pi/2, MSlocal = 0, arrType = _np.array,similarity=False,seed=None):
