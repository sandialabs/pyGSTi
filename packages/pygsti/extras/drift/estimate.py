...
def maximum_likelihood_model(model, data, times, min_p=1e-4, max_p=1 - 1e-6, method='Nelder-Mead',
    ...
    if verbosity > 1:
        ...
        print("      - The -loglikelihood of the seed = {} (with boundard adjustment = {})".format(ll_seed,
                                                                                                   ll_seed_adj))
        print("      - The -loglikelihood of the ouput = {} (with boundard adjustment = {})".format(ll_result,
                                                                                                    ll_result_adj))
