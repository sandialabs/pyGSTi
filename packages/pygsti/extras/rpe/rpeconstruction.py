...
#    rpeconfig_inst = rpeInstanceDict[rpeconfig_inst]
    ...
    sinStrList = []
    for k in kList:
        cosStrList += [_objs.OpString(cos_prep_tuple+cos_germ_tuple*k+cos_meas_tuple,
                                                cos_prep_str+'('+cos_germ_str+')^'+str(k)+cos_meas_str)]
        sinStrList += [_objs.OpString(sin_prep_tuple+sin_germ_tuple*k+sin_meas_tuple,
