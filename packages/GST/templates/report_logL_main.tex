...
\begin{table}[h]
\begin{center}
\putfield{logLProgressTable}{logL progress table will be placed here}
...
\begin{figure}
\begin{center}
\putfield{bestGatesetLogLBoxPlot}{Box plot of best gateset logL}
...
\begin{figure}
\begin{center}
\putfield{bestGatesetLogLInvBoxPlot}{Box plot of best gateset logL with inverted box order}
