...
#Erik should think about making these functions members of EvalTree...
from GateStringTools import pythonStringToGateString as _pythonStringToGateString
from GateStringTools import gateStringToPythonString as _gateStringToPythonString
...
class EvalTree(list):
    ...
    def _initializeBETA(self, gateLabels, gateStringList):
        ...
        for (k,gateString) in enumerate(gateStringList):
            ...
            for repStr,repCnt in repetitions( _gateStringToPythonString(gateString,singleGateLabels) ):
                repGateStr = _pythonStringToGateString(repStr,singleGateLabels)
