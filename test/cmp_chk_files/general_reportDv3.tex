...
Gi & \vcenteredhbox{\includegraphics[width=2.00in,height=2.00in,keepaspectratio]{general_reportDv3_files/targetGatesBoxes_Gi.pdf}} \\ \hline
Gx & \vcenteredhbox{\includegraphics[width=2.00in,height=2.00in,keepaspectratio]{general_reportDv3_files/targetGatesBoxes_Gx.pdf}} \\ \hline
Gy & \vcenteredhbox{\includegraphics[width=2.00in,height=2.00in,keepaspectratio]{general_reportDv3_files/targetGatesBoxes_Gy.pdf}} \\ \hline
\end{tabular}

\caption{\pdftooltip{{\color{blue}\texttt{.tables['targetGatesBoxTable']}}\quad}{Access this information in pyGSTi via<ResultsObject>.tables['targetGatesBoxTable']}\textbf{Target gate set: logic gates}.  These are the \emph{ideal} (generally unitary) logic gates.  Each has a name starting with ``G'', and is represented as a $d^2\times d^2$ \emph{superoperator} that acts by matrix multiplication on vectors in $\mathcal{B}(\mathcal{H})$.  Matrices are displayed using a heat map that ranges between 1.0 (red) and -1.0 (blue).\label{targetGatesTable}}
...
\caption{\pdftooltip{{\color{blue}\texttt{.tables['bestGatesetSpamBriefTable']}}\quad}{Access this information in pyGSTi via<ResultsObject>.tables['bestGatesetSpamBriefTable']}\textbf{The GST estimate of the SPAM operations}.  Compare to Table \ref{targetSpamTable}.\label{bestGatesetSpamTable}}
\end{center}
\end{table}
...
\hline
 & $E_{0}$ & $E_C$ \\ \hline
$\rho_{0}$ & $ \begin{array}{c} 0.090768 \\ \pm 0.00618 \end{array} $ & $ \begin{array}{c} 0.909305 \\ \pm 0.00618 \end{array} $ \\ \hline
\end{tabular}
...
Gi & $ \begin{array}{c} 0.03993 \\ \pm 0.00257 \end{array} $ & $ \begin{array}{c} 0.0401 \\ \pm 0.002571 \end{array} $ & $ \begin{array}{c} 0.040106 \\ \pm 0.002571 \end{array} $ \\ \hline
Gx & $ \begin{array}{c} 0.037847 \\ \pm 0.002167 \end{array} $ & $ \begin{array}{c} 0.037918 \\ \pm 0.002167 \end{array} $ & $ \begin{array}{c} 0.037919 \\ \pm 0.002167 \end{array} $ \\ \hline
Gy & $ \begin{array}{c} 0.037739 \\ \pm 0.002227 \end{array} $ & $ \begin{array}{c} 0.037806 \\ \pm 0.002228 \end{array} $ & $ \begin{array}{c} 0.037806 \\ \pm 0.002228 \end{array} $ \\ \hline
\end{tabular}
...
$\rho_{0}$ & $ \begin{array}{c} 0.049652 \\ \pm 0.003008 \end{array} $ & $ \begin{array}{c} 0.049666 \\ \pm 0.003007 \end{array} $ \\ \hline
$E_{0}$ & $ \begin{array}{c} 0.044736 \\ \pm 0.003889 \end{array} $ & $ \begin{array}{c} 0.045221 \\ \pm 0.003745 \end{array} $ \\ \hline
$E_C$ & $ \begin{array}{c} 0.045521 \\ \pm 0 \end{array} $ & $ \begin{array}{c} 0.045109 \\ \pm 0 \end{array} $ \\ \hline
\end{tabular}
...
Gi & \vcenteredhbox{\includegraphics[width=2.00in,height=2.00in,keepaspectratio]{general_reportDv3_files/bestErrgenBoxes_Gi_errgen.pdf}} & \vcenteredhbox{\includegraphics[width=1.74in,height=1.74in,keepaspectratio]{general_reportDv3_files/bestErrgenBoxes_Gi_hamdecomp.pdf}} \\ \hline
Gx & \vcenteredhbox{\includegraphics[width=2.00in,height=2.00in,keepaspectratio]{general_reportDv3_files/bestErrgenBoxes_Gx_errgen.pdf}} & \vcenteredhbox{\includegraphics[width=1.74in,height=1.74in,keepaspectratio]{general_reportDv3_files/bestErrgenBoxes_Gx_hamdecomp.pdf}} \\ \hline
Gy & \vcenteredhbox{\includegraphics[width=2.00in,height=2.00in,keepaspectratio]{general_reportDv3_files/bestErrgenBoxes_Gy_errgen.pdf}} & \vcenteredhbox{\includegraphics[width=1.74in,height=1.74in,keepaspectratio]{general_reportDv3_files/bestErrgenBoxes_Gy_hamdecomp.pdf}} \\ \hline
\end{tabular}
...
0 & 53.74371 & 61 & -7.256288 & 11.04536 & 0.73 & 92 & 31 & $\bigstar\bigstar\bigstar\bigstar\bigstar$ \\ \hline
1 & 53.74377 & 61 & -7.256232 & 11.04536 & 0.73 & 92 & 31 & $\bigstar\bigstar\bigstar\bigstar\bigstar$ \\ \hline
2 & 106.7092 & 137 & -30.29084 & 16.55295 & 0.97 & 168 & 31 & $\bigstar\bigstar\bigstar\bigstar\bigstar$ \\ \hline
4 & 354.3257 & 410 & -55.6743 & 28.63564 & 0.98 & 441 & 31 & $\bigstar\bigstar\bigstar\bigstar\bigstar$ \\ \hline
8 & 691.064 & 786 & -94.93602 & 39.64846 & 0.99 & 817 & 31 & $\bigstar\bigstar\bigstar\bigstar\bigstar$ \\ \hline
\end{tabular}
...
\begin{figure}
\begin{center}
\includegraphics[width=6.50in,height=7.75in,keepaspectratio]{general_reportDv3_files/bestLogLBoxes_pg0.png}
