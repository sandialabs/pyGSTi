...
\begin{figure}
\begin{center}
\includegraphics[width=6.50in,height=8.00in,keepaspectratio]{full_reportB-noGOptv3_files/directLongSeqGSTChi2Boxes.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=4.00in,height=5.00in,keepaspectratio]{full_reportB-noGOptv3_files/directLongSeqGSTDeviationBoxes.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=4.00in,height=5.00in,keepaspectratio]{full_reportB-noGOptv3_files/smallEigvalErrRateBoxes.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=2.60in,height=2.91in,keepaspectratio]{full_reportB-noGOptv3_files/L1_Chi2Boxes.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=3.90in,height=2.91in,keepaspectratio]{full_reportB-noGOptv3_files/L2_Chi2Boxes.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=5.20in,height=7.27in,keepaspectratio]{full_reportB-noGOptv3_files/L3_Chi2Boxes.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=6.50in,height=8.00in,keepaspectratio]{full_reportB-noGOptv3_files/whackGxMoleBoxes.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=6.50in,height=8.00in,keepaspectratio]{full_reportB-noGOptv3_files/whackGyMoleBoxes.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=6.50in,height=8.00in,keepaspectratio]{full_reportB-noGOptv3_files/whackGiMoleBoxes.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=4in,height=5in,keepaspectratio]{full_reportB-noGOptv3_files/whackGxMoleBoxesSummed.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=4in,height=5in,keepaspectratio]{full_reportB-noGOptv3_files/whackGyMoleBoxesSummed.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=4in,height=5in,keepaspectratio]{full_reportB-noGOptv3_files/whackGiMoleBoxesSummed.pdf}
