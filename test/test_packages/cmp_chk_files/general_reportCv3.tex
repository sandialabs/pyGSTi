...
$\rho_{0}$ & 0.049 & 0.049 \\ \hline
$E_{0}$ & 0.046 & 0.046 \\ \hline
...
\hline
 & I & X & Y & Z \\ \hline
 & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/pauli_ham__I_projector.pdf}} & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/pauli_ham__X_projector.pdf}} & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/pauli_ham__Y_projector.pdf}} & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/pauli_ham__Z_projector.pdf}} \\ \hline
\end{tabular}
...
\hline
 & I & X & Y & Z \\ \hline
 & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/pauli_sto__I_projector.pdf}} & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/pauli_sto__X_projector.pdf}} & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/pauli_sto__Y_projector.pdf}} & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/pauli_sto__Z_projector.pdf}} \\ \hline
\end{tabular}
