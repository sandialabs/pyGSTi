...
Gi & \vcenteredhbox{\includegraphics[width=1.27in,height=1.27in,keepaspectratio]{general_reportCv3_files/targetGatesBoxes_Gi.pdf}} \\ \hline
Gx & \vcenteredhbox{\includegraphics[width=1.27in,height=1.27in,keepaspectratio]{general_reportCv3_files/targetGatesBoxes_Gx.pdf}} \\ \hline
Gy & \vcenteredhbox{\includegraphics[width=1.27in,height=1.27in,keepaspectratio]{general_reportCv3_files/targetGatesBoxes_Gy.pdf}} \\ \hline
\end{tabular}

}
\end{minipage}
\caption{\textbf{Target gate set: SPAM (state preparation and measurement) and logic gates}.  The \textbf{left} table shows the \emph{ideal} input state ($\rho_0$) and `plus' POVM effect $E_0$ for the device on which we report.  SPAM gates are given here as $d\times d$ matrices.  The \textbf{right} table shows the \emph{ideal} (generally unitary) logic gates.  Each has a name starting with ``G'', and is represented as a $d^2\times d^2$ \emph{superoperator} that acts by matrix multiplication on vectors in $\mathcal{B}(\mathcal{H})$.  Matrices are displayed using a heat map that ranges between 1.0 (red) and -1.0 (blue).\label{targetGatesetTable}}
...
Gi & \vcenteredhbox{\includegraphics[width=2.00in,height=2.00in,keepaspectratio]{general_reportCv3_files/targetGatesBoxes_Gi.pdf}} & \vcenteredhbox{\includegraphics[width=2.00in,height=2.00in,keepaspectratio]{general_reportCv3_files/bestGatesBoxes_Gi.pdf}} \\ \hline
Gx & \vcenteredhbox{\includegraphics[width=2.00in,height=2.00in,keepaspectratio]{general_reportCv3_files/targetGatesBoxes_Gx.pdf}} & \vcenteredhbox{\includegraphics[width=2.00in,height=2.00in,keepaspectratio]{general_reportCv3_files/bestGatesBoxes_Gx.pdf}} \\ \hline
Gy & \vcenteredhbox{\includegraphics[width=2.00in,height=2.00in,keepaspectratio]{general_reportCv3_files/targetGatesBoxes_Gy.pdf}} & \vcenteredhbox{\includegraphics[width=2.00in,height=2.00in,keepaspectratio]{general_reportCv3_files/bestGatesBoxes_Gy.pdf}} \\ \hline
\end{tabular}
...
$\rho_{0}$ & 0.048 & 0.048 \\ \hline
$E_{0}$ & 0.046 & 0.047 \\ \hline
$E_C$ & 0.047 & 0.047 \\ \hline
\end{tabular}
...
Gi & \vcenteredhbox{\includegraphics[width=2.00in,height=2.00in,keepaspectratio]{general_reportCv3_files/bestErrgenBoxes_Gi_errgen.pdf}} & \vcenteredhbox{\includegraphics[width=1.56in,height=1.56in,keepaspectratio]{general_reportCv3_files/bestErrgenBoxes_Gi_hamdecomp.pdf}} & \vcenteredhbox{\includegraphics[width=1.56in,height=1.56in,keepaspectratio]{general_reportCv3_files/bestErrgenBoxes_Gi_stodecomp.pdf}} \\ \hline
Gx & \vcenteredhbox{\includegraphics[width=2.00in,height=2.00in,keepaspectratio]{general_reportCv3_files/bestErrgenBoxes_Gx_errgen.pdf}} & \vcenteredhbox{\includegraphics[width=1.56in,height=1.56in,keepaspectratio]{general_reportCv3_files/bestErrgenBoxes_Gx_hamdecomp.pdf}} & \vcenteredhbox{\includegraphics[width=1.56in,height=1.56in,keepaspectratio]{general_reportCv3_files/bestErrgenBoxes_Gx_stodecomp.pdf}} \\ \hline
Gy & \vcenteredhbox{\includegraphics[width=2.00in,height=2.00in,keepaspectratio]{general_reportCv3_files/bestErrgenBoxes_Gy_errgen.pdf}} & \vcenteredhbox{\includegraphics[width=1.56in,height=1.56in,keepaspectratio]{general_reportCv3_files/bestErrgenBoxes_Gy_hamdecomp.pdf}} & \vcenteredhbox{\includegraphics[width=1.56in,height=1.56in,keepaspectratio]{general_reportCv3_files/bestErrgenBoxes_Gy_stodecomp.pdf}} \\ \hline
\end{tabular}
...
\begin{figure}
\begin{center}
\includegraphics[width=6.50in,height=7.25in,keepaspectratio]{general_reportCv3_files/bestLogLBoxes_pg0.png}
...
\hline
\multirow{2}{*}{Gate} & \multicolumn{4}{c|}{Process Infidelity} \\ \cline{2-5}
 & Full & $\mathcal{H}$ + $\mathcal{S}$ & $\mathcal{H}$ & $\mathcal{S}$ \\ \hline
Gi & 0.04 & 0.04 & 1\e{-5} & 0.04 \\ \hline
Gx & 0.038 & 0.038 & 4\e{-6} & 0.038 \\ \hline
Gy & 0.038 & 0.038 & 4\e{-6} & 0.038 \\ \hline
\multirow{2}{*}{} & \multicolumn{4}{c|}{$\nicefrac{1}{2}$ Trace Distance} \\ \cline{2-5} 
 & Full & $\mathcal{H}$ + $\mathcal{S}$ & $\mathcal{H}$ & $\mathcal{S}$ \\ \hline
Gi & 0.04 & 0.04 & 0.003 & 0.04 \\ \hline
Gx & 0.038 & 0.038 & 0.002 & 0.038 \\ \hline
Gy & 0.038 & 0.038 & 0.002 & 0.038 \\ \hline
\multirow{2}{*}{} & \multicolumn{4}{c|}{$\nicefrac{1}{2}$ $\Diamond$-Norm} \\ \cline{2-5} 
 & Full & $\mathcal{H}$ + $\mathcal{S}$ & $\mathcal{H}$ & $\mathcal{S}$ \\ \hline
Gi & 0.04 & 0.04 & 0.003 & 0.04 \\ \hline
Gx & 0.038 & 0.038 & 0.002 & 0.038 \\ \hline
Gy & 0.038 & 0.038 & 0.002 & 0.038 \\ \hline
...
\multirow{2}{*}{Gate} & \multicolumn{4}{c|}{Process Infidelity} \\ \cline{2-5}
 & Full & $\mathcal{H}$ + $\mathcal{S}$ & $\mathcal{H}$ & $\mathcal{S}$ \\ \hline
Gi & 0 & 3\e{-4} & 0.04 & 3\e{-4} \\ \hline
Gx & 0 & 1\e{-4} & 0.038 & 2\e{-4} \\ \hline
Gy & 0 & 2\e{-4} & 0.038 & 2\e{-4} \\ \hline
\multirow{2}{*}{} & \multicolumn{4}{c|}{$\nicefrac{1}{2}$ Trace Distance} \\ \cline{2-5} 
 & Full & $\mathcal{H}$ + $\mathcal{S}$ & $\mathcal{H}$ & $\mathcal{S}$ \\ \hline
Gi & 0 & 0.003 & 0.04 & 0.006 \\ \hline
Gx & 0 & 0.002 & 0.038 & 0.004 \\ \hline
Gy & 0 & 0.002 & 0.038 & 0.004 \\ \hline
\multirow{2}{*}{} & \multicolumn{4}{c|}{$\nicefrac{1}{2}$ $\Diamond$-Norm} \\ \cline{2-5} 
 & Full & $\mathcal{H}$ + $\mathcal{S}$ & $\mathcal{H}$ & $\mathcal{S}$ \\ \hline
Gi & 0 & 0.004 & 0.04 & 0.006 \\ \hline
Gx & 0 & 0.002 & 0.038 & 0.004 \\ \hline
Gy & 0 & 0.002 & 0.038 & 0.004 \\ \hline
\end{tabular}
...
\hline
 & I & X & Y & Z \\ \hline
 & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/errgen_ham__I_projector.pdf}} & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/errgen_ham__X_projector.pdf}} & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/errgen_ham__Y_projector.pdf}} & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/errgen_ham__Z_projector.pdf}} \\ \hline
\end{tabular}
...
\hline
 & I & X & Y & Z \\ \hline
 & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/errgen_sto__I_projector.pdf}} & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/errgen_sto__X_projector.pdf}} & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/errgen_sto__Y_projector.pdf}} & \vcenteredhbox{\includegraphics[width=1.10in,height=1.10in,keepaspectratio]{general_reportCv3_files/errgen_sto__Z_projector.pdf}} \\ \hline
\end{tabular}
...
0.96
 \end{array} $
 & \vcenteredhbox{\includegraphics[width=2.53in,height=2.53in,keepaspectratio]{general_reportCv3_files/goCPTPChoiEvalBars_Gi.pdf}} \\ \hline
Gx & $ \begin{array}{c}
0.011 \\ 
0.013 \\ 
0.014 \\ 
0.962
 \end{array} $
 & \vcenteredhbox{\includegraphics[width=2.53in,height=2.53in,keepaspectratio]{general_reportCv3_files/goCPTPChoiEvalBars_Gx.pdf}} \\ \hline
Gy & $ \begin{array}{c}
0.011 \\ 
0.012 \\ 
0.015 \\ 
0.962
 \end{array} $
 & \vcenteredhbox{\includegraphics[width=2.53in,height=2.53in,keepaspectratio]{general_reportCv3_files/goCPTPChoiEvalBars_Gy.pdf}} \\ \hline
\end{tabular}
