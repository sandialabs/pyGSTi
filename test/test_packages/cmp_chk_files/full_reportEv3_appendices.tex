...
\begin{figure}
\begin{center}
\includegraphics[width=6.50in,height=8.00in,keepaspectratio]{full_reportEv3_files/directLongSeqGSTChi2Boxes.pdf}
\caption{\pdftooltip{{\color{blue}\texttt{.figures['directLongSeqGSTColorBoxPlot']}}\quad}{Access this information in pyGSTi via<ResultsObject>.figures['directLongSeqGSTColorBoxPlot']}\textbf{$\chi^2$ values for ``direct GST'' fit.}  This plot indicates how well direct GST analysis of each base sequence fits the observed data.  By decoupling different base sequences, this analysis largely avoids making any assumptions about Markovianity, and therefore serves as a sanity check on the full GST analysis.  See text for details.\label{directLSGSTChi2BoxPlot}}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[width=4.00in,height=5.00in,keepaspectratio]{full_reportEv3_files/directLongSeqGSTDeviationBoxes.pdf}
\caption{\pdftooltip{{\color{blue}\texttt{.figures['directLongSeqGSTDeviationColorBoxPlot']}}\quad}{Access this information in pyGSTi via<ResultsObject>.figures['directLongSeqGSTDeviationColorBoxPlot']}\textbf{Inconsistency of unitarity between GST and direct GST.}  This plot shows, for each base sequence, the increase in ``upper bound of fidelity with unitary'' (see Table \ref{bestGatesetClosestUnitaryTable}) when using the direct-GST result for a gate sequence instead of the process given by the best gate set.\label{directLSGSTDeviationBoxPlot}}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[width=4.00in,height=5.00in,keepaspectratio]{full_reportEv3_files/smallEigvalErrRateBoxes.pdf}
\caption{\pdftooltip{{\color{blue}\texttt{.figures['smallEigvalErrRateColorBoxPlot']}}\quad}{Access this information in pyGSTi via<ResultsObject>.figures['smallEigvalErrRateColorBoxPlot']}\textbf{Per-gate error rates, extrapolated from the smallest magnitude eigenvalue of the direct GST gate matrix.}  See text for further details.\label{smallEigvalErrRateColorBoxPlot}}
\end{center}
\end{figure}
...
0.072 & 0.001 & 0.952 & -0.007
 \end{array}\!\!\right) $
 \\ \hline
Gy & $ \left(\!\!\begin{array}{cccc}
1.001 & -0.009 & -5\e{-5} & -0.01 \\ 
-0.066 & 0.003 & -0.009 & 0.947 \\ 
2\e{-4} & 0.002 & 0.951 & 0.001 \\ 
...
0.005 & 0.001 & 0.005 & -0.06
 \end{array}\!\!\right) $
 \\ \hline
Gy & $ \left(\!\!\begin{array}{cccc}
1\e{-4} & -0.015 & -1\e{-4} & -0.001 \\ 
-0.111 & -0.048 & -0.004 & -0.003 \\ 
4\e{-4} & 0.002 & -0.05 & -0.001 \\ 
0.005 & -0.005 & -0.01 & -0.057
 \end{array}\!\!\right) $
 \\ \hline
\end{tabular}
...
0.475e^{-i1.57} & 0.489 & 0.021e^{-i1.66} & 0.014e^{i1.57} \\ 
0.019e^{i0.04} & 0.021e^{i1.66} & 0.015 & 0.001e^{-i0.08} \\ 
0.016e^{-i0.12} & 0.014e^{-i1.57} & 0.001e^{i0.08} & 0.01
 \end{array}\!\!\right) $
 & $ \begin{array}{c}
-0.01 \\ 
0.014 \\ 
...
0.019e^{i3.09} & 0.014 & 0.021e^{-i1.65} & 0.001e^{i3.08} \\ 
0.475e^{-i1.57} & 0.021e^{i1.65} & 0.488 & 0.014e^{i1.62} \\ 
...
0.001 & 2\e{-5} & 0.001 & -0.053
 ...
 \\ \hline
Gx & $ \left(\!\!\begin{array}{cccc}
-8\e{-6} & 7\e{-5} & -5\e{-5} & -2\e{-5} \\ 
4\e{-4} & -0.051 & 5\e{-4} & -0.008 \\ 
3\e{-4} & 5\e{-4} & -0.05 & -0.001 \\ 
1\e{-5} & 2\e{-6} & 0.001 & -0.054
 \end{array}\!\!\right) $
 \\ \hline
Gy & $ \left(\!\!\begin{array}{cccc}
2\e{-5} & 2\e{-5} & -3\e{-5} & 6\e{-5} \\ 
...
0.475e^{-i1.57} & 0.488 & 0.001e^{-i3.10} & 0.001e^{i3.09} \\ 
0.001e^{i1.54} & 0.001e^{i3.10} & 0.013 & 9\e{-5}e^{-i2.00} \\ 
0.001e^{-i1.52} & 0.001e^{-i3.09} & 9\e{-5}e^{i2.00} & 0.012
 \end{array}\!\!\right) $
 & $ \begin{array}{c}
0.011 \\ 
0.013 \\ 
...
0.962
 ...
 \\ \hline
Gy & $ \left(\!\!\begin{array}{cccc}
0.488 & 0.002e^{-i1.54} & 0.474e^{i1.57} & 0.001e^{i1.60} \\ 
0.002e^{i1.54} & 0.012 & 0.001e^{i3.05} & 1\e{-4}e^{i2.03} \\ 
0.474e^{-i1.57} & 0.001e^{-i3.05} & 0.488 & 0.001e^{-i3.09} \\ 
0.001e^{-i1.60} & 1\e{-4}e^{-i2.03} & 0.001e^{i3.09} & 0.012
 \end{array}\!\!\right) $
 & $ \begin{array}{c}
0.011 \\ 
0.012 \\ 
...
1 & 7\e{-5} & -1\e{-6} & 3\e{-5} \\ 
4\e{-4} & 0.951 & -0.005 & -0.005 \\ 
0.003 & -0.001 & 0.003 & -0.95 \\ 
2\e{-4} & 5\e{-4} & 0.948 & -0.006
 \end{array}\!\!\right) $
 \\ \hline
Gy & $ \left(\!\!\begin{array}{cccc}
1 & -5\e{-7} & -2\e{-5} & -2\e{-6} \\ 
-0.001 & 5\e{-4} & -0.005 & 0.949 \\ 
4\e{-4} & -0.001 & 0.951 & -0.002 \\ 
0.001 & -0.949 & -0.006 & -0.001
 \end{array}\!\!\right) $
 \\ \hline
\end{tabular}
...
0.002 & -4\e{-4} & -0.045 & -0.002 \\ 
-0.002 & 0.001 & -2\e{-4} & -0.06
 \end{array}\!\!\right) $
 \\ \hline
Gy & $ \left(\!\!\begin{array}{cccc}
2\e{-5} & -2\e{-6} & -2\e{-5} & -1\e{-6} \\ 
-0.001 & -0.051 & 0.001 & 0.001 \\ 
4\e{-4} & -0.003 & -0.05 & -0.001 \\ 
3\e{-4} & 2\e{-4} & -0.009 & -0.054
 \end{array}\!\!\right) $
 \\ \hline
\end{tabular}
...
\multirow{2}{*}{Gate} & \multirow{2}{*}{Angle} & \multicolumn{3}{c|}{Angle between Rotation Axes} \\ \cline{3-5}
 & & Gi & Gx & Gy \\ \hline
Gi & 0.001$\pi$ &  & 0.117$\pi$ & 0.55$\pi$ \\ \hline
Gx & 0.5$\pi$ & 0.117$\pi$ &  & 0.502$\pi$ \\ \hline
Gy & 0.5$\pi$ & 0.55$\pi$ & 0.502$\pi$ &  \\ \hline
\end{tabular}
...
Gate & Choi matrix (Pauli basis) & Eigenvalues \\ \hline
Gi & $ \left(\!\!\begin{array}{cccc}
0.96 & 0.001e^{-i1.79} & 0.002e^{-i1.47} & 0.002e^{i1.39} \\ 
0.001e^{i1.79} & 0.012 & 0.001e^{-i2.92} & 0.002e^{i3.11} \\ 
0.002e^{i1.47} & 0.001e^{i2.92} & 0.013 & 0.001e^{i0.28} \\ 
0.002e^{-i1.39} & 0.002e^{-i3.11} & 0.001e^{-i0.28} & 0.014
 \end{array}\!\!\right) $
 & $ \begin{array}{c}
0.011 \\ 
0.013 \\ 
...
0.96
 ...
 \\ \hline
Gx & $ \left(\!\!\begin{array}{cccc}
0.487 & 0.475e^{i1.57} & 0.002e^{-i1.15} & 0.001e^{i1.52} \\ 
0.475e^{-i1.57} & 0.488 & 0.001e^{-i3.12} & 0.001e^{i2.65} \\ 
0.002e^{i1.15} & 0.001e^{i3.12} & 0.015 & 4\e{-4}e^{-i2.94} \\ 
0.001e^{-i1.52} & 0.001e^{-i2.65} & 4\e{-4}e^{i2.94} & 0.01
 \end{array}\!\!\right) $
 & $ \begin{array}{c}
0.009 \\ 
0.014 \\ 
...
0.962
 ...
 \\ \hline
Gy & $ \left(\!\!\begin{array}{cccc}
0.488 & 0.001e^{-i1.78} & 0.474e^{i1.57} & 0.001e^{i1.30} \\ 
0.001e^{i1.78} & 0.013 & 0.001e^{-i2.94} & 2\e{-4}e^{i0.66} \\ 
0.474e^{-i1.57} & 0.001e^{i2.94} & 0.488 & 0.002e^{i3.05} \\ 
0.001e^{-i1.30} & 2\e{-4}e^{-i0.66} & 0.002e^{-i3.05} & 0.012
 \end{array}\!\!\right) $
 & $ \begin{array}{c}
0.01 \\ 
0.012 \\ 
...
0.001 & 2\e{-5} & 0.001 & -0.053
 ...
 \\ \hline
Gx & $ \left(\!\!\begin{array}{cccc}
-8\e{-6} & 7\e{-5} & -4\e{-6} & 4\e{-6} \\ 
4\e{-4} & -0.051 & 5\e{-4} & -0.009 \\ 
4\e{-4} & 5\e{-4} & -0.051 & -0.001 \\ 
6\e{-6} & -5\e{-5} & 0.001 & -0.054
 \end{array}\!\!\right) $
 \\ \hline
Gy & $ \left(\!\!\begin{array}{cccc}
2\e{-5} & -2\e{-5} & -3\e{-5} & 2\e{-5} \\ 
...
0.001e^{i1.53} & 0.001e^{i3.09} & 0.013 & 8\e{-5}e^{-i1.65} \\ 
0.001e^{-i1.52} & 0.001e^{-i3.10} & 8\e{-5}e^{i1.65} & 0.012
 \end{array}\!\!\right) $
 & $ \begin{array}{c}
0.011 \\ 
0.013 \\ 
...
0.002e^{i1.55} & 0.012 & 0.001e^{i3.06} & 1\e{-4}e^{i2.34} \\ 
0.474e^{-i1.57} & 0.001e^{-i3.06} & 0.488 & 0.001e^{-i3.10} \\ 
0.001e^{-i1.62} & 1\e{-4}e^{-i2.34} & 0.001e^{i3.10} & 0.012
 \end{array}\!\!\right) $
 & $ \begin{array}{c}
0.011 \\ 
0.012 \\ 
...
\begin{figure}
\begin{center}
\includegraphics[width=2.60in,height=2.91in,keepaspectratio]{full_reportEv3_files/L1_Chi2Boxes.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=3.90in,height=2.91in,keepaspectratio]{full_reportEv3_files/L2_Chi2Boxes.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=5.20in,height=7.27in,keepaspectratio]{full_reportEv3_files/L3_Chi2Boxes.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=6.50in,height=8.00in,keepaspectratio]{full_reportEv3_files/whackGxMoleBoxes.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=6.50in,height=8.00in,keepaspectratio]{full_reportEv3_files/whackGyMoleBoxes.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=6.50in,height=8.00in,keepaspectratio]{full_reportEv3_files/whackGiMoleBoxes.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=4in,height=5in,keepaspectratio]{full_reportEv3_files/whackGxMoleBoxesSummed.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=4in,height=5in,keepaspectratio]{full_reportEv3_files/whackGyMoleBoxesSummed.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=4in,height=5in,keepaspectratio]{full_reportEv3_files/whackGiMoleBoxesSummed.pdf}
