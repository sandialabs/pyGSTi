...
class AdvancedParameterizationTestCase(BaseTestCase):
    ...
    def test_sparse_lindblad_param(self):
        ...
        print("spareGate Errgen type (should be sparse):",type(sparseGate.errorgen.err_gen_mx))
        self.assertIsInstance(sparseGate.errorgen.err_gen_mx, sps.csr_matrix)
        self.assertArraysAlmostEqual(gate.errorgen.err_gen_mx,sparseGate.errorgen.err_gen_mx.toarray())
        ...
        self.assertArraysAlmostEqual(gate2.errorgen.err_gen_mx,sparseGate2.errorgen.err_gen_mx.toarray())
