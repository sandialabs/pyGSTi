...
class RepLibTestCase(BaseTestCase):
    ...
    def test_CNOT_convention(self):
        ...
        print( pygsti.tools.process_mx_to_unitary(pygsti.tools.change_basis(std2Q_XYICNOT.gs_target.gates['Gcnot'],'pp','std')))
        print( pygsti.tools.dmvec_to_state(pygsti.tools.change_basis(std2Q_XYICNOT.gs_target.povms['Mdefault']['10'],"pp","std")))

        #Should print (verifying statement):
