...
- [docs/markdown/overview/02-Using-Essential-Objects.md](../docs/markdown/guides/workflow/Workflow.md) — how the core objects fit together.
- [docs/markdown/gst/Overview.md](../docs/markdown/start/FirstGST.md) — the canonical class-API GST tutorial. (Also linked from [gst.md](04-orchestration/gst.md).)
