...
| [`SU2QuditRBDesign`](../../pygsti/protocols/su2rb.py#L230) | su2rb.py:230 | Synthetic-SPAM RB design for an arbitrary-spin SU(2)/qudit system; always uses the hidden-first-gate convention. |
| [`SU2QuditRBSimulator`](../../pygsti/protocols/su2rb.py#L442) | su2rb.py:442 | `DataSimulator` that simulates SU(2) RB circuits directly against a `SpinJ` representation (no full `Model`); `noise_channel` may be a fixed channel or a per-gate callable factory. |
| [`SU2QuditRB`](../../pygsti/protocols/su2rb.py#L911) | su2rb.py:911 | Protocol implementing the rank-1 (Legendre-weighted) synthetic-SPAM RB (R1RB): per-irrep decay fits and rate recovery. |
...
| [`SU2QuditRBResults`](../../pygsti/protocols/su2rb.py#L1110) | su2rb.py:1110 | Results container for `SU2QuditRB` (`rates_dataframe()`, `variance_diagnostic()`). |
