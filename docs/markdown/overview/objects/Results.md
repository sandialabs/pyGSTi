...
As a concrete example, we'll explore one of the `ModelEstimateResults` objects generated by the [GST protocols tutorial](../../algorithms/GST-Protocols.ipynb) (so **if you haven't run this tutorial, go do it now**).
