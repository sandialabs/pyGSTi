...
- `WeakForwardSimulator`: estimates circuit outcome probabilities as observed frequencies over a number of simulated shots.  Paired with the `"chp"` evotype, it simulates Clifford circuits using Scott Aaronson's CHP program.
