...
We can see that the `"TP"` estimate constains the expected gauge-optimized models (see the [Results object tutorial](Results) on how to access the elements of a `ModelEstimateResults` object):
