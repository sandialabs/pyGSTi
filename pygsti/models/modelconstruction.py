...
def create_explicit_fogi_model(processor_spec, custom_gates=None,
                          ...
                          embed_gates=False, basis='pp', op_abbrevs=None, dependent_fogi_action='drop', include_fogv=False):
    ...
    errgen_model.setup_fogi(gauge_basis, None, op_abbrevs, include_spam=True, reparameterize=True, dependent_fogi_action=dependent_fogi_action, include_fogv=include_fogv)
    return errgen_model
