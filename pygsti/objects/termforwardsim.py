...
class TermForwardSimulator(_DistributableForwardSimulator):
    ...
    #REMOVE? - do acton methods work with term calc?
...
#REMOVE - not needed?
#class SimpleTermForwardSimulator(_ForwardSimulator):
#
#    def __init__(self, model,  # below here are simtype-specific args
#                 mode="pruned", max_order=3, desired_perr=0.01, allowed_perr=0.1,
#                 min_term_mag=None, max_paths_per_outcome=1000, perr_heuristic="none",
#                 max_term_stages=5, path_fraction_threshold=0.9, oob_check_interval=10, cache=None):
#        """
...
#        pass  # TODO
#    
#    #def _pr_as_polynomial(self, spam_tuple, circuit, resource_alloc):
#    #    """
...
#    #    Polynomial
#    #    """
#    #    return self._prs_as_polynomials(spam_tuple[0], [spam_tuple[1]], circuit, resource_alloc)[0]
#    #
