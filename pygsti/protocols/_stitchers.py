...
class CircuitStitcher(_NicelySerializable):
    ...
    def from_nice_serialization(cls, state):
        ...
        CircuitStitcher
        """
        # See DesignReducer.from_nice_serialization: NicelySerializable's dispatcher
        # reads "the base class supplies _from_nice_serialization" as "the subclass
        # forgot to", so resolve the concrete class here instead.
