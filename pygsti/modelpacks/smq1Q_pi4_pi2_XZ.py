...
class _Module(SMQModelPack):
    ...
    _germs = [(('Gx', 0), ), (('Gz', 0), ), (('Gz', 0), ('Gx', 0)), (('Gz', 0), ('Gz', 0), ('Gx', 0)),
              (('Gz', 0), ('Gz', 0), ('Gx', 0), ('Gz', 0), ('Gx', 0), ('Gx', 0))]

    _germs_lite = [(('Gx', 0), ), (('Gz', 0), ), (('Gz', 0), ('Gx', 0)), (('Gz', 0), ('Gz', 0), ('Gx', 0))]

    _fiducials = None

    _prepStrs = [(), (('Gx', 0), ('Gx', 0)), (('Gx', 0), ('Gx', 0), ('Gz', 0)),
                 (('Gx', 0), ('Gx', 0), ('Gx', 0), ('Gx', 0)),
                 (('Gx', 0), ('Gx', 0), ('Gx', 0), ('Gx', 0), ('Gx', 0), ('Gx', 0)),
                 (('Gx', 0), ('Gx', 0), ('Gz', 0), ('Gz', 0), ('Gz', 0))]

    _effectStrs = [(), (('Gx', 0), ('Gx', 0)), (('Gz', 0), ('Gx', 0), ('Gx', 0)),
                   (('Gx', 0), ('Gx', 0), ('Gx', 0), ('Gx', 0)),
                   (('Gx', 0), ('Gx', 0), ('Gx', 0), ('Gx', 0), ('Gx', 0), ('Gx', 0)),
    ...
    def _target_model(self):
        return _setc.build_explicit_model([(0, )], [('Gx', 0), ('Gz', 0)], ['X(pi/4,0)', 'Z(pi/2,0)'])
