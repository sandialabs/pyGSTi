...
def commute_errors(ErG1,ErG2, weightFlip=1.0, BCHweight=1.0):
    ...
    if ErG1.getType()=='H' and ErG2.getType()=='H':
        ...
        errorGens.append( _LSE( 'C' , [ErG2.basis_element_labels[0] , pVec[1]] , 1j*wT*pVec[0] ) )
        ...
        errorGens.append( _LSE('C' , [pVec1[1], ErG2.basis_element_labels[1]] , 1j*wT*pVec1[0] ) )
        pVec2=com(ErG2.basis_element_labels[1] , ErG1.basis_element_labels[0])
        errorGens.append( _LSE('C' , [pVec2[1] , ErG2.basis_element_labels[0]] , 1j*wT*pVec2[0] ) )
        ...
        errorGens.append( _LSE('A'  , [pVec1[1] , ErG2.basis_element_labels[1]] , -1j*wT*pVec1[0]) )
        pVec2 = com(ErG1.basis_element_labels[0] , ErG2.basis_element_labels[1])
        errorGens.append( _LSE('A'  , [ErG2.basis_element_labels[0], pVec2[1]] , -1j*wT*pVec2[0] ) )
                          
    elif ErG1.getType()=='A' and ErG2.getType()=='H':
        errorGens = commute_errors(ErG2,ErG1,weightFlip=-1.0,BCHweight=BCHweight)

    elif ErG1.getType()=='S' and ErG2.getType()=='S':
        errorGens.append( _LSE('H', ErG1.basis_element_labels[0],0 ))
       ...
       errorGens.append( _LSE( 'A' , [pVec1[1], pVec2[1]] , -1j*wT*pVec1[0]*pVec2[0]  ))
       ...
       errorGens.append( _LSE( 'A'  ,[pVec2[1], ErG1.basis_element_labels[0]] , -1j*.5*wT*pVec1[0]*pVec2[0]))
       pVec1=acom(ErG2.basis_element_labels[0], ErG2.basis_element_labels[1])
       pVec2=labelMultiply(ErG1.basis_element_labels[0],pVec1[1])
       errorGens.append( _LSE( 'A',   [ErG1.basis_element_labels[0] ,pVec2[1]],-1j*.5*wT*pVec1[0]*pVec2[0]))
       ...
       pVec1 =labelMultiply(ErG1.basis_element_labels[0] , ErG2.basis_element_labels[0])
       pVec2=labelMultiply(ErG2.basis_element_labels[1] , ErG1.basis_element_labels[0])
       errorGens.append( _LSE( 'C', [pVec1[1], pVec2[1]] ,1j*wT*pVec1[0]*pVec2[0] ))
       pVec1=labelMultiply(ErG1.basis_element_labels[0] , ErG2.basis_element_labels[1])
       pVec2=labelMultiply(ErG2.basis_element_labels[0] , ErG1.basis_element_labels[0])
       errorGens.append( _LSE( 'C', [pVec1[1], pVec2[1]] , -1j*wT*pVec1[0]*pVec2[0]))
       pVec1 = com(ErG2.basis_element_labels[0] , ErG2.basis_element_labels[1])
       pVec2 = com(ErG1.basis_element_labels[0],pVec1[1])
       errorGens.append( _LSE( 'A', [ErG1.basis_element_labels[0], pVec2[1]] ,-.5*wT*pVec1[0]*pVec2[0]))
       ...
       errorGens = commute_errors(ErG2,ErG1,weightFlip=-1.0,BCHweight=BCHweight)
        ...
        pVec1=acom(A,B)
        pVec2=com(P,pVec1[1])
        errorGens.append( _LSE( 'A'  , [pVec2[1] , Q ], -.5*1j*wT*pVec1[0]*pVec2[0]))
        pVec1=acom(A,B)
        pVec2=com(Q,pVec1[1])
        errorGens.append( _LSE( 'A'  , [pVec2[1], P] , -.5*1j*wT*pVec1[0]*pVec2[0]))
        pVec1=acom(P,Q)
        pVec2=com(pVec1[1],A)
        errorGens.append( _LSE( 'A' , [pVec2[1] , B] , -.5*1j*wT*pVec1[0]*pVec2[0]))
        pVec1=acom(P,Q)
        pVec2=com(pVec1[1],B)
        errorGens.append( _LSE( 'A' , [pVec2[1] , A ] , -.5*1j*wT*pVec1[0]*pVec2[0]))
        pVec1=acom(A,B)
        pVec2=acom(P,Q)
        pVec3=com(pVec1[1],pVec2[1])
        errorGens.append( _LSE( 'H', [pVec3[1]] ,.25*1j*wT*pVec1[0]*pVec2[0]*pVec3[0]))
        ...
        pVec1 = com(P,Q)
        pVec2 =com(A,pVec1[1])
        errorGens.append( _LSE('A'  , [pVec2[1] , B] , .5*wT*pVec1[0]*pVec2[0] ))
        pVec1 = com(P,Q)
        pVec2 =com(B,pVec1[1])
        errorGens.append( _LSE('A' , [pVec2[1],  A ], .5*wT*pVec1[0]*pVec2[0] ))
        pVec1 = acom(A,B)
        pVec2 =com(P,pVec1[1])
        errorGens.append( _LSE('C', [pVec2[1] , Q ], .5*1j*wT*pVec1[0]*pVec2[0] ))
        pVec1 = acom(A,B)
        pVec2 =com(Q,pVec1[1])
        errorGens.append( _LSE('C',[pVec2[1],P ],-.5*1j*wT*pVec1[0]*pVec2[0] ))
        pVec1 = com(P,Q)
        pVec2 =acom(A,B)
        pVec3=com(pVec1[1],pVec2[1])
        errorGens.append( _LSE('H',[pVec3[1]],-.25*wT*pVec1[0]*pVec2[0]*pVec3[0]))
        ...
        pVec1=com(P,Q)
        pVec2=com(B,pVec1[1])
        errorGens.append(_LSE('C',[pVec2[1],A],.5*wT*pVec1[0]*pVec2[0]))
        pVec1=com(P,Q)
        pVec2=com(A,pVec1[1])
        errorGens.append(_LSE('C',[pVec2[1],B] ,-.5*wT*pVec1[0]*pVec2[0]))
        pVec1=com(A,B)
        pVec2=com(P,pVec1[1])
        errorGens.append(_LSE('C', [pVec2[1],Q] ,.5*wT*pVec1[0]*pVec2[0]))
        pVec1=com(A,B)
        pVec2=com(Q,pVec1[1])
        errorGens.append(_LSE('C', [pVec2[1],P]  ,-.5*wT*pVec1[0]*pVec2[0]))
        pVec1=com(P,Q)
        pVec2=com(A,B)
        pVec3=com(pVec1[1],pVec2[1])
        errorGens.append( _LSE('H',[pVec3[1]] ,.25*wT*pVec1[0]*pVec2[0]*pVec3[0]))
