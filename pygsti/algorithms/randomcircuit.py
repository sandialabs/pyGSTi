...
def sample_random_clifford_one_qubit_unitary_parameters():
    ...
    TODO: docstring
    """
    theta1 = _compy.mod_2pi(_np.random.randint(4) * _np.pi / 4)
    theta2 = _compy.mod_2pi(_np.random.randint(4) * _np.pi / 4)
    theta3 = _compy.mod_2pi(_np.random.randint(4) * _np.pi / 4)
    return (theta1, theta2, theta3)
