...
class Autosummary(Directive):
    ...
    #print "DEBUG: Autosummary Directive Processing "
    ...
    def get_items(self, names):
        ...
        """
        #print "DEBUG: get_items for ",names
        env = self.state.document.settings.env

        prefixes = get_import_prefixes_from_env(env)
        #print "DEBUG: prefixes = ",prefixes
        ...
        for name in names:
            ...
            try:
                ...
                #print "DEBUG: warning: failed to import %s" % name
                items.append((name, '', '', name))
                continue

            #print "DEBUG: imported %s" % name
            ...
            #print "DEBUG: getting documenter for ",full_name
            documenter = get_documenter(obj, parent)(self, full_name)
            if not documenter.parse_name():
                self.warn('failed to parse name %s' % real_name)
                #print "DEBUG: warning: failed to parse name %s" % real_name
                items.append((display_name, '', '', real_name))
                continue
            if not documenter.import_object():
                self.warn('failed to import object %s' % real_name)
                #print "DEBUG: warning: failed to import object %s" % real_name
                items.append((display_name, '', '', real_name))
                continue
            if not documenter.check_module():
                #print "DEBUG: check_module failed"
                pass #continue #EGN: changed this ONE line so package __init__.py imports get documented and not skipped.
            ...
            try:
                ...
                #print "DEBUG: error: module analyzer failed %s" % err
            ...
            #print "DEBUG: appending item ",display_name
    ...
    def get_table(self, items):
        ...
        *items* is a list produced by :meth:`get_items`.
        """
        #print "DEBUG: get_table for ",items
